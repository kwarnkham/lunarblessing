<template>
  <q-page padding>
    <h1>Privacy Policy for Lunar Blessing</h1>
    <p>
      At Lunar Blessing, accessible from
      https://lunarblessing.madewithheart.tech/, one of our main priorities is
      the privacy of our visitors. This Privacy Policy document contains types
      of information that is collected and recorded by Lunar Blessing and how we
      use it.
    </p>
    <p>
    ...
    <p>
      ...
      and/or collect in Lunar Blessing. This policy is not applicable to any
    ...
    <h2>Log Files</h2>
    <p>
      Lunar Blessing follows a standard procedure of using log files. These
    ...
    <p>
      Like any other website, Lunar Blessing uses 'cookies'. These cookies are
    ...
    <P
      ...
      advertising partners of Lunar Blessing.</P
    >
    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on Lunar Blessing, which are sent
    ...
    <p>
      Note that Lunar Blessing has no access to or control over these cookies
      that are used by third-party advertisers.
    </p>
    <h2>Third Party Privacy Policies</h2>
    <p>
      Lunar Blessing's Privacy Policy does not apply to other advertisers or
    ...
    <p>
      Lunar Blessing does not knowingly collect any Personal Identifiable
